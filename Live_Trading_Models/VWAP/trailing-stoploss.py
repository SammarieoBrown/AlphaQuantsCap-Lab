...
TRAIL_AMOUNT = 0.3  # Amount by how much SL updates
...
def trail_sl():
    ...
    if dist_from_sl > MAX_DIST_SL:
        ...
        if sl != 0.0:
            ...
            # new_sl = price_open - stoploss_standard_dev * standard_deviation if order_type == 0 else price_open +
            # stoploss_standard_dev * standard_deviation
